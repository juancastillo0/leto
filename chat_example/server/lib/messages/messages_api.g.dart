...
final _getMessageLinksMetadataGraphQLField = HotReloadableDefinition<
    ...
    (setValue) => setValue(linksMetadataGraphQLType.nonNull().field<Object?>(
          ...
          ..inputs.addAll([graphQLString.nonNull().inputField('message')]));
...
final _chatMessageGraphQLType =
  ...
  __chatMessageGraphQLType.fields.addAll(
    [
      ...
      messageTypeGraphQLType.nonNull().field(
            'type',
            resolve: (
              obj,
              ctx,
      ...
      messageMetadataGraphQLType.field(
        'metadata',
        resolve: (
          obj,
          ctx,
...
final _chatMessageSentEventGraphQLType =
  ...
  __chatMessageSentEventGraphQLType.fields.addAll(
    [
      chatMessageGraphQLType.nonNull().field(
            'message',
            resolve: (
              obj,
              ctx,
...
final _chatMessageDeletedEventGraphQLType =
  ...
  final __chatMessageDeletedEventGraphQLType =
      objectType<ChatMessageDeletedEvent>(
    __name,
    isInterface: false,
    interfaces: [],
  );
...
final _chatMessageUpdatedEventGraphQLType =
  ...
  final __chatMessageUpdatedEventGraphQLType =
      objectType<ChatMessageUpdatedEvent>(
    __name,
    isInterface: false,
    interfaces: [],
  );
...
final GraphQLEnumType<MessageType> messageTypeGraphQLType = GraphQLEnumType(
  'MessageType',
  [
    GraphQLEnumValue(
      'FILE',
